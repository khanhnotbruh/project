...
1. Dòng 1: In ‘YES’ nếu S1 và S2 là bạn bè, ngược lại in ‘NO’

2. Dòng 2: In ‘YES’ nếu S3 và S4 là bạn bè, ngược lại in ‘NO’

3. Dòng 3: In ‘YES’ nếu S5 và S6 là bạn bè, ngược lại in ‘NO’

**Ví dụ:**

| Dữ liệu vào | Dữ liệu ra |
| :--- | :--- |
| aabbbccccb aabccccaaaaa aabbbccccbcc aadddccccaaa xyzabc aaaaxxyxxzcccb | YES NO YES |

*Ghi chú:* Bài được chấm qua 8 test, mỗi test đúng được 0,25 điểm:

1. 6 test có độ dài của mỗi xâu ký tự không vượt quá 255

2. 2 test có độ dài của mỗi xâu ký tự không vượt quá 1000
